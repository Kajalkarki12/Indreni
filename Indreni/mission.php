            ...
            <div class="col col-md-8 col-md-push-4">
                <div class="service-single-content">
                    ...
                    <h2 style="font-size:25px;" >Mission</h2>
                       ...
                       <p style="font-size:15px";>Good governance, competition, technology-enabled services, happy and satisfied members, non-financial services, accessible, quality, latest financial services, institutional capabilities (marketing, risk management, human resource management, membership growth), bureaucracy, advocacy and lobbying.</p>
                ...
                <div class="service-single-sidebar">
                    <div class="services-link-widget widget">
                        ...
                        <ul>
                                                                    ...
                                                                    <li  style="font-size:15px;"><a href="#">Mission</a></li>
                                                                    <li  style="font-size:15px;"><a href="goal.php">Goal</a></li>
