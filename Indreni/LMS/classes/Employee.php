		...
		if ($imgError === 0) {
			if ($imgSize < 50000) {
				...
				move_uploaded_file($imgTmpName, $fileDestination);
					...
					VALUES('$borrower_name','$borrower_nid','$borrower_gender','$borrower_mobile','$borrower_email','$borrower_dob','$borrower_address','$borrower_working_status','$fileDestination')";
