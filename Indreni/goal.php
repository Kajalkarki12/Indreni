...
<section class="service-singel-section section-padding" style="padding-top:20px">
    <div class="container">
        <div class="row">
            <div class="col col-md-8 col-md-push-4">
                <div class="service-single-content">
                    ...
                    <h2 style="font-size:25px;">Goal</h2>
                </div>
                        <p style="font-size:15px">Providing competitive and quality services in the financial sector,
To provide non-financial services to members in accordance with the spirit of cooperatives,
Proper utilization and management of local resources,
Emphasis on commercialization of members,
Development and expansion of necessary physical infrastructure as well as institutional development by producing skilled manpower.
To promote good governance as an inclusive institution.</p>
            ...
            <div class="col col-md-4 col-md-pull-8">
                <div class="service-single-sidebar">
                    <div class="services-link-widget widget">
                        <h2 style="background-color:green; color:white; font-size:15px; padding:10px;">Related Page</h2>
                        <ul>
                                                                    <li style="font-size:15px;"><a href="index.php">Home</a></li>
                                                                    <li style="font-size:15px;"><a href="mission.php">Mission</a></li>
                                                                    <li style="font-size:15px;"><a href="#">Goal</a></li>
                                                                    <li style="font-size:15px;"><a href="objective.php">Objective</a></li>
